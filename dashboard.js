...
function showTab(tab){
  ...
  // when opening analytics, force charts to resize so they render correctly
  if (tab === "analytics" && typeof tempChart !== "undefined" && typeof humChart !== "undefined") {
    tempChart.resize();
    humChart.resize();
  }
}
...
db.ref("weather").on("value",snap=>{
  ...
  // NOTE: this id doesn't exist in HTML; left from older version
